...
//      Class projectClass = Class.forName(ProjectEnum.DERBY.getName());
        Class projectClass = Class.forName(ProjectEnum.argouml.getName());
//      Class irModelClass = Class.forName(IREnum.LSI.getModel()); // select an IR model, ex: LSI
//        Class irModelClass = Class.forName(IREnum.LSI.getModel()); // select an IR model, ex: LSI
        Class irModelClass = Class.forName(IREnum.VSM.getModel()); // select an IR model, ex: LSI
