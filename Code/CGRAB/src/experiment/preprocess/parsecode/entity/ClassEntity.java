...
public class ClassEntity {
	...
	public String toString() {
		return "ClassEntity [id=" + id + ", packageName=" + packageName + ", className=" + className
				+ ", superClassName=" + superClassName + ", superInterface=" + superInterface + ", classComment="
				+ classComment + ", field=" + field + ", method=" + method + "]";
	}
}
