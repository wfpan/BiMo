package experiment.project.keyclass;

import experiment.project.Project;
import experiment.project.ProjectConfig;

/**set the project name, projectPath, and define lots of paths in the dataset*/
public class jmeter_core implements Project {

    public static String projectName = "jmeter_core";
    public static String projectPath = "dataset/jmeter_core";
